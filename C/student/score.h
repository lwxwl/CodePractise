...
void DoOpen(STUDENT **pstu, int);     // void DoOpen(STUDENT **, int);
void DoSave(STUDENT **pstu, int);     // void DoSave(STUDENT **, int);
void Doinput(STUDENT **pstu, int);    // void Doinput(STUDENT **, int);
void DoSearch(STUDENT **pstu, int);   // void DoSearch(STUDENT **, int);
void DoEdit(STUDENT **pstu, int);     // void DoEdit(STUDENT **, int);
void DoShow(STUDENT **pstu, int);     // void DoShow(STUDENT **, int);
void DoSort(STUDENT **pstu, int);     // void DoSort(STUDENT **, int);
void Dotongji(STUDENT **pstu, int);   // void Dotongji(STUDENT **, int);
